                ...
                <div className="report-container">
                    ...
                    <div className="report-container__select-container">
                        <select>
                            ...
                            <option value="option2">Chatbot</option>
                            <option value="option3">DEBUG</option>
                            <option value="option4">DEBUG 2</option>
                        </select>
                        <select className="report-container__select-container__date-select">
                            <option value="option1">2024-10-25</option>
                            <option value="option2">2024-10-24</option>
                            <option value="option3">2024-10-23</option>
                        </select>
